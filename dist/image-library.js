  ...
  (() => {
    ...
    var a = {
        d: (b, n) => {
          for (var e in n)
            a.o(n, e) &&
              !a.o(b, e) &&
              Object.defineProperty(b, e, { enumerable: !0, get: n[e] });
        },
    ...
    const n = {
        ...
        upi: {
          ...
          tataneu: ["tataneu", "tata neu", "com.tatadigital.tcp"],
          snapmint: ["snap mint", "com.snapmint.customerapp"],
        },
        wallet: {
          airtel: [
            "airtel",
      ...
      e = {
        SIZE_MAPPING: { sm: "32", md: "64", lg: "128", svg: "svg" },
        IMAGE_TYPE: { sm: "png", md: "png", lg: "png", svg: "svg" },
    ...
    function r(a, b) {
      let r = i(b),
        c = e.DEFAULT_URL;
      "svg" === r && (c += "?width=130&height=130");
      let s = { icon_name: "default", icon_version: "1", icon_url: c };
      return a
        ? ((a = (function (a) {
            return (
              (a = (a = a?.toLowerCase() || "")
                ...
                .replace(/ +/g, " ")),
              /^[a-z]{4}0[a-z0-9]{6}$/.test(a) && (a = a.slice(0, 4)),
              a.trim()
            );
          })(a)),
          Object.entries(n).every(([b, n]) => {
            let i = !0;
            return (
              Object.keys(n).every((c) => {
                if (n[c].includes(a)) {
                  let a = "snapmint" === c ? b : e.PAYMENT_MODE_MAPPING[c],
                    n = `${e.IMAGE_URL}/${a}/${e.SIZE_MAPPING[r]}/${c}.${e.IMAGE_TYPE[r]}`;
                  return (
                    "svg" === r && (n += "?width=130&height=130"),
                    (s = { icon_name: c, icon_version: "1", icon_url: n }),
                    (i = !1),
                    !1
                  );
                }
    ...
    function s(a, b) {
      ...
      return (
        Object.keys(n[a]) &&
          Object.keys(n[a]).forEach((b) => {
            let n = "snapmint" === b ? a : e.PAYMENT_MODE_MAPPING[b],
              i = `${e.IMAGE_URL}/${n}/${e.SIZE_MAPPING[r]}/${b}.${e.IMAGE_TYPE[r]}`;
            ("svg" === r && (i += "?width=130&height=130"),
              c.push({ icon_name: b, icon_version: "1", icon_url: i }));
          }),
        c
      );
    }
    const t = { getIcon: r, getIcons: c, getModesIcons: s };
    return b;
  })(),
);
